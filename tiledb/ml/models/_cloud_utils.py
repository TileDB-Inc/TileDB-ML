...
#     :param teamspace: User's teamspace
#     :return: S3 prefix
#     """
...
#     #     return None
#     # profile = tiledb.cloud.user_profile()
...
def get_cloud_uri(filename: str, teamspace: Optional[str]) -> str:
    ...
    #     )
    org = tiledb.client.get_workspace().name
    return f"tiledb://{org}/{teamspace}/{CLOUD_MODELS}/{filename}"
